...
### Ước tính Chi phí Control Tower Landing Zone (v4.0)

Dưới đây là ước tính chi phí khi chạy Control Tower v4.0 trên region us-east-1 với 5 accounts:

| Thành phần | Ước tính/tháng | Ghi chú |
|---|---|---|
| AWS Control Tower | $0 | Bản thân service miễn phí |
| AWS Organizations | $0 | Miễn phí |
| CloudTrail (Org trail) | ~$2-10 | Phụ thuộc vào volume events. Management events copy đầu tiên miễn phí, data events tính phí |
| AWS Config | ~$5-30/account × 5 = $25-150 | Config recorder ghi lại config items (~$0.003/item). Đây thường là chi phí lớn nhất |
| S3 (CloudTrail logs + Config logs) | ~$5-20 | Retention 365 ngày + access logs 3650 ngày, tích lũy theo thời gian |
| CloudWatch Logs | ~$2-10 | CloudTrail logs đẩy vào CloudWatch |
| SNS Notifications | < $1 | Rất ít |
| IAM Identity Center | $0 | Miễn phí (accessManagement enabled) |

**Tổng ước tính: ~$35 - $190/tháng** cho setup hiện tại (5 accounts, 1 governed region).

- Nếu workload ít (mới setup, ít activity): gần mức **$35-50/tháng**.
- Nếu nhiều activity/resources: có thể lên **$100-190/tháng**.

Chi phí sẽ tăng tuyến tính nếu bạn thêm governed regions hoặc accounts.
